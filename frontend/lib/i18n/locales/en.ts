const en = {
  translation: {
    ...
    runs: {
      title: 'Run Center',
      description: 'Track active and recent long-running agent tasks in one place.',
      ...
      hoursSuffix: 'h ago',
      daysSuffix: 'd ago',
      searchPlaceholder: 'Search run titles',
    ...
    workspace: {
      ...
      apiKeys: 'API Tokens',
      apiKeysDescription: "Manage API tokens that have access to this workspace's resources.",
    ...
    skills: {
      ...
      skillApiTokensDescription: 'Manage tokens scoped to this skill for programmatic execution.',
      copy: 'Copy',
      copyCode: 'Copy Code',
    },
    skillVersions: {
